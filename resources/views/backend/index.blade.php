                                    ...
                                    <div class="product_content">
                                        <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                            <div>
                                                <div>
                                                    ...
                                                    <div class="product_name"><img src="{{asset('assets/images/location-point.png')}}" style="margin-bottom: 3px;margin-right: 2px;"><a href="product.html" style="color: #7f8c8d;">{{$build->city}}, Indonesia</a></div>
                                                </div>
                                        ...
                                        <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                            <div style="position: relative; bottom: 15px;">
                                                ...
                                                <div><a style="color: black">/Person </a><img src="{{asset('assets/images/circle.png')}}" style="width: 8px; height: 8px;"><a style="color: black"> 1 nights</a></div>
                                        ...
                                        <div class="product_buttons">
                                            <div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">
                                                ...
                                                @else
                                                    <a href="{{route('Base.checkin', $build->id)}}" class="btn btn-success submit-btn btn-block" style="height: 60px;font-weight: bolder; font-size: 30px;">Check</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
